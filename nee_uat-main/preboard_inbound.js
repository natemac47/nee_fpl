    ...
    // Retrieve hiringmangerid from the email body_text
	...
	logger.log('Manager ID ' + hiringmangerid);
	logger.log('Manager Name ' + profile.getDisplayValue('user'));
...
hiringmangerid: 10090669

 

hiringmanager: Paulette R Kwasniak
